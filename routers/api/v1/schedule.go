...
func CreateCourse(c *gin.Context) {
	...
	if exist {
		appG.Response(http.StatusBadRequest, e.UnknownError, nil)
		return
	}
...
func Schedule(c *gin.Context) {
	...
	//	"u6": []string{"v1", "v3"},
	//}
	appG.Response(http.StatusOK, e.OK, map[string]interface{}{
		"Data": utility.MaxMatch(request.TeacherCourseRelationShip)})
}
